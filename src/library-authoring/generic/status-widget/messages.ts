...
const messages = defineMessages({
  ...
  unpublishedStatusLabel: {
    ...
    defaultMessage: '(Có thay đổi chưa xuất bản)',
  ...
  lastPublishedMsg: {
    ...
    defaultMessage: 'Được xuất bản lần cuối vào {date} lúc {time} bởi {user}.',
  ...
  lastPublishedMsgWithoutUser: {
    ...
    defaultMessage: 'Được xuất bản lần cuối vào {date} lúc {time}.',
    description: 'Body message of the library authoring sidebar when the entity is published.',
  },
  lastDraftMsg: {
