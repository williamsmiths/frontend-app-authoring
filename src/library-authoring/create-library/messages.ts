...
const messages = defineMessages({
  ...
  slugHelp: {
    ...
    defaultMessage: `Mã duy nhất xác định thư viện này. Lưu ý: Đây là 
    một phần của URL thư viện, vì vậy không được dùng khoảng trắng hoặc ký tự đặc biệt. 
    Không thể thay đổi.`,
    description: 'Help text for the slug field.',
  },
  invalidSlugError: {
    id: 'course-authoring.library-authoring.create-library.form.invalid-slug.error',
    defaultMessage: 'Hãy nhập một “slug” hợp lệ gồm chữ cái Unicode, số, dấu gạch dưới (_) hoặc dấu gạch nối (-).',
