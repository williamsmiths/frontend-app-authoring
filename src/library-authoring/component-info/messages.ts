...
const messages = defineMessages({
  ...
  advancedDetailsOLXEditWarning: {
    ...
    defaultMessage: 'Cẩn thận! Đây là tính năng nâng cao và lỗi có thể làm hỏng component.',
  ...
  advancedDetailsOLXEditFailed: {
    ...
    defaultMessage: 'Đã xảy ra lỗi và OLX không thể lưu.',
  ...
  updateComponentSuccessMsg: {
    ...
    defaultMessage: 'Cập nhật component thành công.',
  ...
  updateComponentErrorMsg: {
    ...
    defaultMessage: 'Có lỗi xảy ra khi cập nhật component.',
  ...
  publishComponentButtonTitle: {
    ...
    defaultMessage: 'Xuất bản component',
  ...
  detailsTabUsageTitle: {
    ...
    defaultMessage: 'Sử dụng component',
  ...
  detailsTabUsageEmpty: {
    ...
    defaultMessage: 'Component này không được sử dụng trong khóa học nào.',
  ...
  detailsTabHistoryTitle: {
    ...
    defaultMessage: 'Lịch sử component',
  ...
  previewModalTitle: {
    ...
    defaultMessage: 'Xem trước component',
  ...
  publishSuccessMsg: {
    ...
    defaultMessage: 'Xuất bản component thành công.',
  ...
  publishErrorMsg: {
    ...
    defaultMessage: 'Có lỗi xảy ra khi xuất bản component.',
