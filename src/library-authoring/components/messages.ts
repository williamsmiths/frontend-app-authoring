...
const messages = defineMessages({
  componentCardMenuAlt: {
    ...
    defaultMessage: 'Menu thao tác component',
  ...
  removeComponentFromCollectionSuccess: {
    ...
    defaultMessage: 'Đã gỡ thành công',
  ...
  deleteComponentConfirmMsg1: {
    ...
    defaultMessage: 'Nếu component này đã được sử dụng trong khóa học, các bản sao sẽ không bị xóa nhưng sẽ không còn nhận cập nhật từ thư viện.',
  ...
  deleteComponentConfirmMsg2: {
    ...
    defaultMessage: 'Nếu component này đã được sử dụng trong bất kỳ unit nào, nó cũng sẽ bị xóa khỏi các unit đó.',
  ...
  deleteComponentSuccess: {
    ...
    defaultMessage: 'Component đã được xóa',
  ...
  undoDeleteComponentToastFailed: {
    ...
    defaultMessage: 'Hoàn tác xóa component thất bại',
    description: 'Message to display on failure to undo delete component',
  },
  // Các thông báo về collection
  deleteCollection: {
  ...
  deleteCollectionSuccess: {
    ...
    defaultMessage: 'Bộ sưu tập đã được xóa',
  ...
  publishConfirmationBody: {
    ...
    defaultMessage: 'Xuất bản tất cả thay đổi chưa xuất bản của component này?',
  ...
  publishConfirmationDownstreamsAlert: {
    ...
    defaultMessage: 'Component này có thể được đồng bộ trong khóa học sau khi xuất bản.',
  ...
  deleteUnitConfirmMsg1: {
    ...
    defaultMessage: 'Các instance của khóa học sẽ không còn nhận cập nhật.',
  ...
  deleteUnitConfirmMsg2: {
    ...
    defaultMessage: 'Các component vẫn sẽ ở lại trong thư viện.',
  ...
  undoDeleteUnitToastFailed: {
    ...
    defaultMessage: 'Hoàn tác xóa Unit thất bại',
  ...
  removeComponentFromContainerSuccess: {
    ...
    defaultMessage: 'Component đã được gỡ thành công',
  ...
  removeComponentFromContainerFailure: {
    ...
    defaultMessage: 'Gỡ component thất bại',
  ...
  undoRemoveComponentFromContainerToastFailed: {
    ...
    defaultMessage: 'Hoàn tác gỡ component thất bại',
    description: 'Message to display on failure to undo delete component',
  },
});
