...
const messages = defineMessages({
  ...
  addMemberFormTitle: {
    ...
    defaultMessage: 'Thêm người dùng vào nhóm thư viện',
  ...
  addMemberFormEmailLabel: {
    ...
    defaultMessage: 'Email của người dùng',
  ...
  addMemberFormEmailHelperText: {
    ...
    defaultMessage: 'Nhập địa chỉ email của người dùng bạn muốn thêm',
  ...
  cannotChangeRoleSingleAdmin: {
    ...
    defaultMessage: 'Hãy cấp quyền Admin cho thành viên khác để thay đổi quyền của người dùng này.',
    description: (
