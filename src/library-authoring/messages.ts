...
const messages = defineMessages({
  ...
  noSearchResults: {
    ...
    defaultMessage: 'Không tìm thấy thành phần nào khớp trong thư viện này.',
  ...
  createLibraryTempPlaceholder: {
    ...
    defaultMessage: 'Đây là phần giữ chỗ cho biểu mẫu tạo thư viện. Nó sẽ được thay thế bằng biểu mẫu thực tế.',
