...
const messages = defineMessages({
  ...
  sectionInfo: {
    ...
    defaultMessage: 'Sử dụng cập nhật khóa học để thông báo cho học viên về các ngày quan trọng hoặc kỳ thi, làm nổi bật các thảo luận cụ thể trên diễn đàn, thông báo thay đổi lịch trình và phản hồi câu hỏi của học viên.',
  ...
  newUpdateButton: {
    ...
    defaultMessage: 'Tạo cập nhật mới',
  ...
  noCourseUpdates: {
    ...
    defaultMessage: 'Bạn chưa thêm cập nhật nào cho khóa học này.',
  ...
  savingUpdatesErrorDescription: {
    ...
    defaultMessage: 'Không thể lưu các thay đổi gần đây của cập nhật khóa học. Vui lòng thử lại sau.',
  ...
  savingHandoutsErrorDescription: {
    ...
    defaultMessage: 'Không thể lưu các thay đổi gần đây của tài liệu khóa học. Vui lòng thử lại sau.',
