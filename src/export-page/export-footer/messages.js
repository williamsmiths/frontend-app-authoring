...
const messages = defineMessages({
  exportedDataTitle: {
    ...
    defaultMessage: 'Dữ Liệu Được Xuất Cùng Khóa Học:',
  },
  exportedDataItem1: {
    id: 'course-authoring.export.footer.exportedData.item.1',
    defaultMessage: 'Các giá trị từ Cài đặt Nâng cao, bao gồm khóa API MATLAB và hộ chiếu LTI',
  },
  exportedDataItem2: {
    id: 'course-authoring.export.footer.exportedData.item.2',
    defaultMessage: 'Nội dung khóa học (tất cả các phần, phần phụ và đơn vị)',
  },
  exportedDataItem3: {
  ...
  exportedDataItem6: {
    ...
    defaultMessage: 'Tài sản khóa học',
  },
  exportedDataItem7: {
  ...
  notExportedDataTitle: {
    ...
    defaultMessage: 'Dữ Liệu Không Được Xuất Cùng Khóa Học:',
  },
