...
const messages = defineMessages({
  rowStatusMessage: {
    ...
    defaultMessage: 'Hiển thị {fileCount} trên {rowCount}',
  ...
  fileSizeError: {
    ...
    defaultMessage: 'Tệp tải lên phải có kích thước 20 MB trở xuống. Vui lòng giảm kích thước và thử lại.',
  ...
  downloadEncodingsTitle: {
    ...
    defaultMessage: 'Tải danh sách video (.csv)',
  ...
  deleteConfirmationMessage: {
    ...
    defaultMessage: `
      Bạn có chắc muốn xóa {fileNumber, plural, one {{fileName}} other {{fileNumber} {fileType}}}?
      Hành động này không thể hoàn tác và có thể làm hỏng khóa học nếu {fileNumber, plural, one {{fileType} đang} other {{fileType} đang}}
      được sử dụng trong nội dung khóa học, cài đặt nâng cao, cập nhật hoặc lịch trình.
    `,
  ...
  deleteConfirmationUsageMessage: {
    ...
    defaultMessage: '{fileNumber, plural, one {{fileType} đang} other {{fileType} đang}} được sử dụng trong nội dung khóa học. Hãy cân nhắc cập nhật trước khi xóa.',
  ...
  sortBySizeDescending: {
    ...
    defaultMessage: 'Kích thước (lớn → nhỏ)',
  ...
  sortBySizeAscending: {
    ...
    defaultMessage: 'Kích thước (nhỏ → lớn)',
