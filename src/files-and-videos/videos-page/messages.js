...
const messages = defineMessages({
  ...
  videoUploadAlertLabel: {
    ...
    defaultMessage: 'Đang tải lên. Vui lòng chờ quá trình hoàn tất trước khi rời khỏi trang này.',
  ...
  videoUploadTrackerAlertTitle: {
    ...
    defaultMessage: 'Không đóng hoặc làm mới trang/tab này cho đến khi tải lên hoàn tất',
  ...
  videoUploadTrackerAlertBodyMessage: {
    ...
    defaultMessage: 'Thoát ngay bây giờ sẽ xóa toàn bộ tiến trình tải lên. Cửa sổ này sẽ tự đóng khi tải lên thành công.',
  ...
  videoUploadTrackerAlertEditMessage: {
    ...
    defaultMessage: 'Bạn muốn tiếp tục chỉnh sửa trong Studio trong khi tải lên?',
  ...
  videoUploadTrackerAlertEditHyperlinkLabel: {
    ...
    defaultMessage: 'Mở Studio trong tab mới',
  ...
  videoUploadTrackerModalBody: {
    ...
    defaultMessage: '({uploadCount}) {uploadCount, plural, one {video đang} other {video đang}} được tải lên:',
