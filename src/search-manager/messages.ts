...
const messages = defineMessages({
  ...
  clearUsageKeyToSearch: {
    ...
    defaultMessage: 'Đang hiển thị một nội dung, hãy xóa bộ lọc để tìm kiếm',
  ...
  'blockTagsFilter.incomplete': {
    ...
    defaultMessage: 'Xin lỗi, không thể tải tất cả thẻ',
  ...
  'blockType.openassessment': {
    ...
    defaultMessage: 'Đánh giá tự luận',
  ...
  'blockType.choiceresponse': {
    ...
    defaultMessage: 'Trắc nghiệm một lựa chọn',
  ...
  submitSearchTagsByKeyword: {
    ...
    defaultMessage: 'Gửi tìm kiếm thẻ',
  ...
  searchSortRecentlyPublished: {
    ...
    defaultMessage: 'Xuất bản gần đây',
  ...
  searchSortRecentlyModified: {
    ...
    defaultMessage: 'Chỉnh sửa gần đây',
  ...
  publishStatusModified: {
    ...
    defaultMessage: 'Đã chỉnh sửa sau khi xuất bản',
