...
const messages = defineMessages({
  ...
  defaultSection_1_Description: {
    ...
    defaultMessage: 'Người tạo khóa học phải cấp quyền truy cập cho bạn. Hãy liên hệ với người tạo hoặc quản trị viên của khóa học mà bạn đang hỗ trợ xây dựng.',
  },
