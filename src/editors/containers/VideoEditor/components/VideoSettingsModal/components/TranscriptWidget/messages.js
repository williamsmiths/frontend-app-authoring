...
const messages = defineMessages({
  ...
  addFirstTranscript: {
    ...
    defaultMessage: 'Thêm phụ đề video (chỉ hỗ trợ tệp .srt) để cải thiện khả năng tiếp cận.',
  ...
  allowDownloadCheckboxLabel: {
    ...
    defaultMessage: 'Cho phép tải xuống phụ đề',
  ...
  showByDefaultCheckboxLabel: {
    ...
    defaultMessage: 'Hiển thị phụ đề trong trình phát video theo mặc định',
    description: 'Label for show by default checkbox',
  },
  tooltipMessage: {
    id: 'authoring.videoeditor.transcripts.upload.allowDownloadTooltipMessage',
    defaultMessage: 'Người học sẽ thấy liên kết để tải phụ đề bên dưới video.',
  ...
  uploadTranscriptError: {
    ...
    defaultMessage: 'Tải lên phụ đề thất bại. Vui lòng thử lại.',
  ...
  fileSizeError: {
    ...
    defaultMessage: 'Kích thước tệp phụ đề vượt quá giới hạn. Vui lòng thử lại.',
  ...
  deleteTranscriptError: {
    ...
    defaultMessage: 'Xóa phụ đề thất bại. Vui lòng thử lại.',
  ...
  fileTypeWarning: {
    ...
    defaultMessage: 'Chỉ có thể tải lên tệp SRT. Vui lòng chọn tệp có đuôi .srt.',
  ...
  importMessage: {
    ...
    defaultMessage: 'Chúng tôi đã tìm thấy phụ đề cho video này trên YouTube. Bạn có muốn nhập ngay bây giờ không?',
