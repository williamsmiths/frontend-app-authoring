...
const messages = defineMessages({
  ...
  aspectRequirements: {
    ...
    defaultMessage: 'Hình ảnh phải có tỷ lệ 16:9 (khuyến nghị 1280x720 px)',
    description: 'Message for thumbnail aspectRequirements',
  },
  thumbnailAltText: {
    id: 'authoring.videoeditor.thumbnail.altText',
    defaultMessage: 'Hình ảnh dùng làm hình thu nhỏ cho video',
  ...
  fileSizeError: {
    ...
    defaultMessage:
      'Kích thước tệp hình thu nhỏ phải lớn hơn 2 KB và nhỏ hơn 2 MB. Vui lòng thay đổi kích thước hình ảnh và thử lại.',
    description:
