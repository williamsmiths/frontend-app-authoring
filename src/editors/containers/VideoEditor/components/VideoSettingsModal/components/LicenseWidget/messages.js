...
const messages = defineMessages({
  ...
  courseLevelDescription: {
    ...
    defaultMessage: 'Giấy phép này hiện được đặt ở cấp độ khóa học',
  ...
  courseLicenseDescription: {
    ...
    defaultMessage: 'Giấy phép ở cấp độ khóa học sẽ hiển thị ở cuối các trang nội dung trong khóa học của bạn.',
  ...
  libraryLevelDescription: {
    ...
    defaultMessage: 'Giấy phép này hiện được đặt ở cấp độ thư viện',
  ...
  libraryLicenseDescription: {
    ...
    defaultMessage: 'Giấy phép ở cấp độ thư viện sẽ hiển thị tại video cụ thể trong thư viện.',
  ...
  defaultLicenseDescription: {
    ...
    defaultMessage: 'Khi video có giấy phép khác với toàn bộ khóa học, người học sẽ thấy giấy phép ở góc dưới bên phải của trình phát video.',
  ...
  attributionSectionDescription: {
    ...
    defaultMessage: 'Cho phép người khác sao chép, phân phối, hiển thị và trình diễn tác phẩm của bạn nhưng phải ghi công theo yêu cầu của bạn. Hiện tại, tùy chọn này là bắt buộc.',
  ...
  noncommercialSectionDescription: {
    ...
    defaultMessage: 'Cho phép người khác sao chép, phân phối, hiển thị và trình diễn tác phẩm của bạn - và các tác phẩm phái sinh - nhưng chỉ cho mục đích phi thương mại.',
  ...
  noDerivativesSectionDescription: {
    ...
    defaultMessage: 'Cho phép người khác sao chép, phân phối, hiển thị và trình diễn chỉ các bản sao nguyên vẹn của tác phẩm của bạn, không phải các tác phẩm phái sinh. Tùy chọn này không tương thích với "Chia sẻ tương tự".',
  ...
  shareAlikeSectionDescription: {
    ...
    defaultMessage: 'Cho phép người khác phân phối các tác phẩm phái sinh chỉ với giấy phép giống với giấy phép của bạn. Tùy chọn này không tương thích với "Không phái sinh".',
  ...
  allRightsReservedSectionMessage: {
    ...
    defaultMessage: 'Bạn giữ tất cả các quyền đối với tác phẩm của mình.',
