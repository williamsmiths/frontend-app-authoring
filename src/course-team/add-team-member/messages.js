...
const messages = defineMessages({
  title: {
    ...
    defaultMessage: 'Thêm thành viên vào khóa học này',
  },
  description: {
    id: 'course-authoring.course-team.add-team-member.description',
    defaultMessage: 'Thêm thành viên giúp việc xây dựng khóa học trở nên cộng tác hơn. Người dùng phải đăng ký Studio và có tài khoản đang hoạt động.',
  },
  button: {
