...
const messages = defineMessages({
  ...
  homeTabDescription: {
    ...
    defaultMessage: 'Khóa học của bạn chứa nội dung từ các thư viện sau.',
  ...
  homeTabDescriptionEmpty: {
    ...
    defaultMessage: 'Khóa học này không sử dụng nội dung từ thư viện nào.',
    description: 'Description text for home tab',
  },
  reviewTabTitle: {
  ...
  reviewTabDescriptionEmpty: {
    id: 'course-authoring.course-libraries.tab.home.description-no-links',
    defaultMessage: 'Tất cả các thành phần đều đã được cập nhật',
    description: 'Description text for home tab',
  },
  breadcrumbLabel: {
  ...
  outOfSyncCountAlertTitle: {
    ...
    defaultMessage: '{outOfSyncCount, plural, one {# thành phần thư viện} other {# thành phần thư viện}} chưa đồng bộ. Hãy xem xét cập nhật để chấp nhận hoặc bỏ qua thay đổi',
  ...
  brokenLinkTooltip: {
    ...
    defaultMessage: 'Nguồn từ thư viện - nhưng liên kết gốc bị hỏng hoặc không hợp lệ.',
  ...
  unitsUpdatesWarning: {
    ...
    defaultMessage: 'Hiện tại trang này chỉ theo dõi cập nhật của các thành phần. Để kiểm tra cập nhật của các bài học (unit), hãy vào Course Outline.',
