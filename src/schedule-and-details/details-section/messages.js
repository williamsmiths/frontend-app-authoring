...
const messages = defineMessages({
  ...
  dropdownHelpText: {
    ...
    defaultMessage: 'Xác định ngôn ngữ của khóa học tại đây. Điều này giúp người dùng tìm các khóa học được giảng dạy bằng ngôn ngữ cụ thể. Nó cũng được dùng để bản địa hóa trường "From:" trong email gửi hàng loạt.',
  },
  dropdownEmpty: {
