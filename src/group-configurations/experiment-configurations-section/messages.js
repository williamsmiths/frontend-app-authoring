...
const messages = defineMessages({
  ...
  experimentConfigurationGroupsFeedback: {
    ...
    defaultMessage: 'Tên của các nhóm mà sinh viên sẽ được phân vào, ví dụ: Control, Video, Problems. Bạn phải có hai nhóm trở lên.',
  ...
  experimentConfigurationDeleteRestriction: {
    ...
    defaultMessage: 'Không thể xóa khi đang được sử dụng trong một thí nghiệm',
  ...
  experimentConfigurationAlert: {
    ...
    defaultMessage: 'Cấu hình này đang được sử dụng trong các thí nghiệm nội dung. Nếu bạn thay đổi nhóm, bạn có thể cần chỉnh sửa các thí nghiệm đó.',
  ...
  emptyExperimentGroup: {
    ...
    defaultMessage: 'Cấu hình nhóm này chưa được sử dụng. Bắt đầu bằng cách thêm một thí nghiệm nội dung vào bất kỳ Unit nào qua {outlineComponentLink}.',
  ...
  deleteRestriction: {
    ...
    defaultMessage: 'Không thể xóa khi đang được sử dụng trong một Unit',
